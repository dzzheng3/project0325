...
public class AvailableGameAdapter extends RecyclerView.Adapter<AvailableGameAdapter.ViewHolder> {

    private Context context;
    private ArrayList<raGameModel> gameModels;

    public AvailableGameAdapter(Context context, ArrayList<raGameModel> gameItem) {
